...
print('n_total = {:.2e} m^-3'.format(n_total[x]*1e6))
print('n_N2    = {:.2e} m^-3'.format(n_N2[x]*1e6))
print('%_N2    = {:.1f} %'.format(n_N2[x]/n_total[x]*100))
print('n_O2    = {:.2e} m^-3'.format(n_O2[x]*1e6))
print('%_O2    = {:.1f} %'.format(n_O2[x]/n_total[x]*100))
print('n_N     = {:.2e} m^-3'.format(n_N[x]*1e6))
print('%_N     = {:.1f} %'.format(n_N[x]/n_total[x]*100))
print('n_O     = {:.2e} m^-3'.format(n_O[x]*1e6))
print('%_O     = {:.1f} %'.format(n_O[x]/n_total[x]*100))
print('n_Ar    = {:.2e} m^-3'.format(n_Ar[x]*1e6))
print('%_Ar    = {:.1f} %'.format(n_Ar[x]/n_total[x]*100))
print('n_He    = {:.2e} m^-3'.format(n_He[x]*1e6))
print('%_He    = {:.1f} %'.format(n_He[x]/n_total[x]*100))
print('n_H     = {:.2e} m^-3'.format(n_H[x]*1e6))
print('%_H     = {:.1f} %'.format(n_H[x]/n_total[x]*100))
