...
fig, ax = plt.subplots(figsize=figure_size)
l1 = ax.semilogy(H,n_total,'-',label='total')
...
ax.set_ylabel('Number density, m$^-$$^3$')
ax2 = ax.twinx()
l5 = ax2.plot(H,v_sc,'k',label='orbital speed')
ax2.set_ylim(7700,7900)
ax2.set_ylabel('Orbital Velocity, m/s ')
ls = l1+l2+l3+l4+l5
labs = [l.get_label() for l in ls]
ax2.legend(ls,labs,framealpha=1.0)
ax.grid()
ax.set_title('Density vs Altitude')
fig.tight_layout()
...
ax3.set_ylim(0,45)
ax3.set_ylabel('Maximum flow angle, $\degree$')
